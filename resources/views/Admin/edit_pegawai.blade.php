                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                <form action="{{ url('update_pegawai', $pegawai->id) }}" method="POST">
                                @csrf
                                <div class="form-group">
                                            <label class="form-label" for="nip">NIP</label>
                                            <input type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" id="nip" placeholder="Isi NIP" value="{{ $pegawai->nip }}">
                                            @error('nip')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nama_pegawai') is-invalid @enderror" name="nama_pegawai" id="nama_pegawai" value="{{ $pegawai->nama_pegawai }}">
                                            @error('nama_pegawai')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" id="jabatan" placeholder="Masukkan jabatan" value="{{ $pegawai->jabatan }}">
                                            @error('jabatan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
