            ...
            <form id="pc-form-event" novalidate>
              @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pc-e-title" placeholder="Masukkan Nama Kegiatan"
                        autofocus>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Tempat Pelaksanaan"
                        id="pc-e-venue">
                </div>

                <div class="form-group">
                    <label class="form-label">Pelaksana Kegiatan</label>
                    <input type="text" class="form-control" placeholder="Masukkan Pelaksana Kegiatan"
                        id="pc-e-organizer">
                </div>

                <div class="form-group">
                    <label class="form-label">Kelengkapan Pelaksanaan</label>
                    <input type="text" class="form-control" placeholder="Masukkan Kelengkapan Pelaksanaan"
                        id="pc-e-equipment">
                </div>

                <div class="form-group">
                    <label class="form-label">Berkas Pelaksanaan</label>
                    <input type="text" class="form-control" placeholder="Masukkan Berkas Pelaksanaan"
                        id="pc-e-documents">
                </div>
