            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <small
                    >All of the data export buttons have an exportOptions option which can be used to specify information about what data
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <small
                    >This example makes use of buttons.exportData() to get data from the host DataTable and then create a file with JSON
                    data</small
                  >
                </div>
                <div class="card-body">
