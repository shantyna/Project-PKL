...
if (pc_event_add) {
  pc_event_add.addEventListener('click', function () {
    ...
    calendar.addEvent({
      ...
      organizer: document.getElementById('pc-e-organizer').value,
      equipment: document.getElementById('pc-e-equipment').value,
      documents: document.getElementById('pc-e-documents').value,
